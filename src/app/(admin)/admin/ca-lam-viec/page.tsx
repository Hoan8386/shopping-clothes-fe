  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between bg-card rounded-2xl border border-subtle p-4 lg:p-5">
        <div>
          <h1 className="text-lg font-bold text-foreground">Quản lý ca làm việc</h1>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        <div className="bg-card border border-subtle rounded-xl p-4">
          <p className="text-xs text-muted uppercase tracking-wide">Hoạt động</p>
            ...
            <div className="p-5 space-y-4">
              <div>
                ...
                <input
                  type="text"
                  value={form.tenCaLam}
                  onChange={(e) => setForm({ ...form, tenCaLam: e.target.value })}
      ...
      {deleteId && (
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-card rounded-xl shadow-xl w-full max-w-sm p-6">
            <h3 className="font-bold text-lg text-foreground mb-2">Xóa ca làm việc?</h3>
            <p className="text-sm text-muted mb-5">
              Thao tác này không thể hoàn tác. Ca làm việc sẽ bị xóa khỏi hệ thống.
            </p>
