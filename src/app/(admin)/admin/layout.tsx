...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    const pageDescriptions: Record<string, string> = {
        ...
        'Khách hàng': 'Theo dõi danh sách khách hàng đã đăng ký trên hệ thống.',
        ...
        'Báo cáo thống kê': 'Theo dõi thống kê  và xuất Excel theo kỳ lọc.',
    };
        ...
        <div className="flex min-h-screen bg-section/40">
            ...
            <main className="flex-1 overflow-x-hidden min-h-screen">
                <div className="lg:hidden sticky top-0 z-30 bg-card border-b border-subtle px-4 py-3 flex items-center gap-3">
                    ...
                    <span className="text-sm font-semibold text-foreground">LUXE Admin</span>
                </div>
